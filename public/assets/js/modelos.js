...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_product_table = document.querySelector('.datatables-products'),
    productAdd = '/cadastros/modelos/cadastrar';
          ...
          features: [
            {
              ...
              buttons: [
                ...
                {
                  text: '<i class="icon-base ri ri-add-line me-0 me-sm-1 icon-16px"></i><span class="d-none d-sm-inline-block">Adicionar Modelo</span>',
