...
<html
  ...
  <head>
    ...
    <title>Redefinir senha | Carros.Net</title>
        ...
        <div class="authentication-inner py-6 mx-4">
          <div class="card p-sm-7 p-2">
            ...
            <div class="card-body mt-1">
              ...
              <p class="mb-5">Sua senha deve ser diferente da utilizada anteriormente</p>
              <form id="formAuthentication" class="mb-5" action="{{ route('password.store') }}" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100 mb-5">Redefinir senha</button>
