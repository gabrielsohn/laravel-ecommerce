...
<html
  ...
  <head>
    ...
    <title>Cadastro | Carros.Net</title>
        ...
        <div class="authentication-inner py-6 mx-4">
          ...
          <div class="card p-sm-7 p-2">
            ...
            <div class="card-body mt-1">
              <h4 class="mb-1">Administre seus anúncios 🚀</h4>
              <p class="mb-5">Faça cadastros, edição e deleção dos seus anúncios!</p>
              ...
              <form id="formAuthentication" class="mb-5" action="{{ route('register.store') }}" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100 mb-5">Cadastrar</button>
              </form>
